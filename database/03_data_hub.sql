-- ═══════════════════════════════════════════════════════════════════
-- 03_data_hub.sql — Sistema de Conectores y Mapeo Dinámico de Datos
...
CREATE TABLE IF NOT EXISTS MetricMappings (
    ...
    FechaActualizacion TEXT       NOT NULL DEFAULT (datetime('now','localtime'))
);
...
INSERT OR IGNORE INTO DataConnectors (Nombre, Tipo, Configuracion) 
...
INSERT OR IGNORE INTO MetricMappings (SeccionUI, CampoValor, MetodoCalculo, Periodicidad)
VALUES 
