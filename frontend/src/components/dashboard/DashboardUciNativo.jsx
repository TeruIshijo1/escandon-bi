                ...
                {isOcupada ? (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', borderTop: '1px solid #F1F5F9', paddingTop: '0.6rem', marginTop: '0.2rem' }}>
                    ...
                    <div style={{ 
                      ...
                      alignItems: 'center',
                      border: '1.5px dashed rgba(239,68,68,0.1)'
                    }}>
                      <span style={{ fontSize: '0.74rem', fontWeight: 700, color: '#B91C1C', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Cargos UCI</span>
                      <span style={{ fontSize: '0.9rem', fontWeight: 850, color: '#EF4444', fontFamily: 'var(--font-mono)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                ...
                <div style={{ fontSize: '1.6rem', fontWeight: 850, color: '#EF4444', fontFamily: 'var(--font-mono)' }}>
